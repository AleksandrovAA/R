...
Коробчатые диаграммы на пересечении *crim* и *chas* показывают, что наличие тракта вокруг реки не влияет на уровень преступности на душу населения в разбивке по городам. Однако влияет на долю акров не розничного бизнеса на один город (где наличие тракта = 0(отсутствует) доля чуть больше) и на полную стоимость имущества-ставка налога на имущество за \$10 000 (где наличие тракта = 0(отсутствует) ставка значительно больше)
...
#ggpairs(df.train[, c('exper', 'educ', 'crim')],
#aes(color = educ), upper = list(combo = 'box'))

# цвета по фактору forlang
#ggpairs(df.train[, c('exper', 'forlang', 'crim')],
...
При увеличении значения k результат становится точнее (приближается к регрессии  по всем факторам).
